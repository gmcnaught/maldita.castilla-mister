...
/* MALDITA OVERLAY — the entire local change to this header is this declaration.
 * Consume-and-clear the CONF_STR T/R trigger pulses latched since the last call,
 * as a bit mask over the 32-bit (non-extended) status word. See the definition
 * in user_io.cpp for why the pulse cannot be observed any other way. */
