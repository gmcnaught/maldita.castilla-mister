...
#============================================================================
#
#  build_maldita.sh -- Build the Maldita MiSTer RBF from the command line.
#
...
#
#  Usage: ./build_maldita.sh [output_dir]
...
OUTPUT_DIR="${1:-../_Other}"
PROJECT="Maldita"           # matches Maldita.qpf revision (don't change)
RBF_PREFIX="MalditaCastilla"        # output filename prefix → MalditaCastilla_YYYYMMDD.rbf
DATE=$(date +%Y%m%d)
...
echo "============================================"
echo "  MiSTer_Maldita -- Quartus Build"
